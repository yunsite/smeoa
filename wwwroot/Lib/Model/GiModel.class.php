...
class GiModel extends CommonModel {
    ...
    function get_wait_sql(){
		...
		$sql.=" (select po.po_no,po.supplier,po_item.mat_no,po_item.qty order_qty,po.po_date,po.user_id,po.user_name,po.remark,po_item.remark item_remark,po.is_del";
